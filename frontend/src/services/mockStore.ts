...
// Consolidates all rules, UI colors, and capabilities previously found in platformRules.ts
...
// NOTE: INITIAL_MEDIA generation relies on evaluateCompatibility, which now needs the registry.
// We handle this inside the class constructor or a static init block.
